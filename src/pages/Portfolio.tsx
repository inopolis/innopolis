    ...
    <div>
        ...
        <main>
            <section id="bio">
                ...
                <p>I primarily use Python, C++, and JavaScript for programming, along with HTML and CSS for web development.
                </p>
            </section>
            ...
            <section id="projects">
                ...
                <ul>
                    ...
                    <li><a href="https://sport.innopolis.university" target="_blank" rel="noopener noreferrer">new my.uni sport</a> - New
                        my.university website</li>
